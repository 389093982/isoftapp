...
var TableInit = function () {
    ...
    oTableInit.Init = function () {
        $('#appids-table').bootstrapTable({
            url: '/appmanager/loadAppIdsData/',           //请求后台的URL（*）
            method: 'get',                      //请求方式（*）
    ...
    oTableInit.queryParams = function (params) {
        var temp = {   //这里的键的名字和控制器的变量名必须一直，这边改动，控制器也需要改成一样的
            ...
            app_id: $("#txt_search_app_id").val(),
            app_name: $("#txt_search_app_name").val(),
            app_owner: $("#txt_search_app_owner").val(),
...
function operateFormatter(value, row, index) {//赋予的参数
    var href = "/appmanager/projects_list/?app_id=" + row.app_id;
    return '<a href="' + href + '" title="查看相关的项目信息"><span class="glyphicon glyphicon-eye-open" aria-hidden="true"></span></a>';
}